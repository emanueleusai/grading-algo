...
df = pd.read_csv('grading-data/gc_10683.202310_fullgc_2023-05-06-12-32-07.csv')
...
df[['Username',"LAB_AVG","QUIZ_AVG","HW_AVG","EXAM_AVG",'total','letter']].to_csv("grading-data/output_bb.csv")
